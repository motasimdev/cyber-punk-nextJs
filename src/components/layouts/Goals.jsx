        ...
        <Container>
          <div className="flex px-16 items-center justify-between">
            ...
            <div className="w-[50%]">
              ...
              >
                Your <span className=" text-transparent bg-clip-text bg-linear-to-r from-[#e03609] to-[#f0b71f]">Portal to a Gritty,</span> Tech-Driven Future.
              </h4>
              <p className={`${montserrat.className} py-12 font-medium text-[17px] text-[#dddddd]`}>A realm where advanced technology meets dystopian reality. Our website is your gateway to a universe of neon lights, gritty streets, and cybernetic enhancements. </p>
              <div className="flex gap-x-10">
                <button className="bg-linear-to-r from-[#f0b71f] to-[#e03609] px-5 py-3 text-[17px] font-semibold text-white rounded-lg hover:bg-linear-to-r hover:from-[#e03609] hover:to-[#f0b71f] transition-colors duration-700 cursor-pointer">
                  ...
                  <div className="group bg-linear-to-r from-[#f0b71f] to-[#e03609] p-px rounded-lg">
                    ...
                    <span className=" text-transparent bg-clip-text bg-linear-to-r from-[#e03609] to-[#f0b71f] group-hover:text-white transition-colors duration-500">Learn More</span>
                  </button>
                  </div>
              </div>
            </div>
